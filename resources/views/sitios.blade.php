...
<html lang="en">
    ...
    <div class="showcase bgShowcase">
        <div class="container bgBlanco">
            ...
            <h3><b><a class="text-white"href="#">LUGARES TURÍSTICOS DE TOURS PERÚ QUE PUEDES VIAJAR EN 2022</a></h3>
            </div> 
            <!-- Post Row -->
            ...
            <div id="blog">
                ...
                <div class="">
        			...
        			<div class="section_header bg-primary ">
                        <h3><b><a class="text-white" href="#">PAQUETES ESPECIALES DESTACADOS</a></h3>
                    </div> 
                    <!-- Post Row -->
                    <div class="row post_row">
                        <!-- Post -->
