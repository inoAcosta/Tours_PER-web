                    ...
                    <div class="row post_row">
                        ...
                        <div class="col-sm-4">
                            <div class="post">
                                ...
                                <div class="text">
                                    <h3><a class="textDestino" href="cuzco-maravilloso.php">VALLE DE COLCA <br>  PERÚ</a></h3>
                                    <p class="text-black "><span>DESDE:</span> S/. 3000.00</p>
                                    <p class="text-black "><span>Duraci&oacute;n:</span></p>
                                    <p class="text-black ">4 D&iacute;as / 3 Noches</p>
            ...
            <form>
                <div class="sign-in-wrapper">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-dark text-dark me-2"><a href="/login" class="nav-link text-white">INGRESAR</button></a>
                    </div>
                    <div class="text-center">
